  ...
  try {
    ...
    const result = await pool.query(
      `INSERT INTO sellergold 
        (name, category, weight, purity, condition, price, description, images, full_name, mobilenumber, typeofselling, status, street_no, landmark, state, district, mandal)
    ...
    const result = await pool.query(
      `UPDATE sellergold 
       SET name = $1, category = $2, weight = $3, purity = $4, condition = $5, 
           ...
           street_no = $13, landmark = $14, state = $15, district = $16, mandal = $17
       WHERE id = $18
       RETURNING *`,
      [
        name, 
