...
// ---------------------------------------------------------
// POST: Add a new sell gold price record
// ---------------------------------------------------------
router.post("/add", async (req, res) => {
  ...
  try {
    ...
    return res.status(201).json({
      success: true,
      message: "Sell gold price details added successfully",
      data: result.rows[0]
    });
...
// ---------------------------------------------------------
// PUT: Update an existing sell gold price record dynamically
// ---------------------------------------------------------
...
// ---------------------------------------------------------
// DELETE: Remove a sell gold price record
// ---------------------------------------------------------
router.delete("/delete/:id", async (req, res) => {
  const targetId = req.params.id;

  try {
    const query = "DELETE FROM sell_gold_prices WHERE id = $1 RETURNING id, karat, price, date;";
